...
export function StatsCardSkeleton() {
  ...
  return (
    <div className={`p-6 rounded-2xl border shadow-lg animate-pulse ${
      currentTheme === "dark" 
        ? "bg-gradient-to-br from-gray-800 to-gray-700/50 border-gray-700" 
        : "bg-gradient-to-br from-white to-gray-50/50 border-gray-100"
    }`}>
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="text-right">
          <div className={`h-4 w-16 rounded mb-2 animate-pulse ${
            currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
          }`}></div>
...
export function KanbanColumnSkeleton() {
  ...
  return (
    <div className={`flex-1 border rounded-xl shadow-lg ${
      currentTheme === "dark" 
      ...
      <div className={`p-6 border-b ${
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className={`h-6 w-8 rounded-full animate-pulse ${
            currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
          }`}></div>
        </div>
      </div>
...
export function ProcessHeaderSkeleton() {
  ...
  return (
    <header className={`sticky top-0 z-20 backdrop-blur-xl transition-all duration-300 border-b shadow-sm ${
      currentTheme === "dark" 
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="flex flex-col gap-2 flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <div className={`h-11 w-40 rounded animate-pulse ${
            ...
            <div className="flex flex-col gap-2 mt-2">
              <div className="flex items-center gap-2 flex-wrap">
                {/* Process number */}
                <div className={`h-8 w-56 rounded-lg animate-pulse ${
                  currentTheme === "dark" ? "bg-blue-900/30 border-2 border-blue-500" : "bg-blue-50 border-2 border-blue-300"
                }`}></div>
                {/* Badges */}
                <div className={`h-7 w-20 rounded-lg animate-pulse ${
                  currentTheme === "dark" ? "bg-gray-700" : "bg-gray-200"
                }`}></div>
                <div className={`h-7 w-24 rounded-lg animate-pulse ${
                  currentTheme === "dark" ? "bg-gray-700" : "bg-gray-200"
                }`}></div>
              </div>
      ...
      {/* Breadcrumb section */}
      <div className={`border-t ${currentTheme === "dark" ? "border-gray-700" : "border-gray-100"}`}>
        <div className="max-w-[1920px] w-full mx-auto px-3 sm:px-4 lg:px-6 xl:px-8 py-3">
          <div className="flex items-center gap-2">
            ...
            <div className={`h-4 w-2 rounded animate-pulse ${
              currentTheme === "dark" ? "bg-gray-700" : "bg-gray-200"
            }`}></div>
...
export function ProcessInfoCardSkeleton() {
  const { theme, mounted } = useTheme(); const currentTheme = mounted ? theme : "light";
  
  return (
    <div className={`border rounded-xl p-6 shadow-sm animate-pulse mb-6 ${
      currentTheme === "dark" 
        ? "bg-gray-800 border-gray-700" 
        : "bg-white border-gray-200"
    }`}>
  ...
  return (
    <div className={`border rounded-xl p-6 shadow-sm animate-pulse mb-6 ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <div className={`h-5 w-20 rounded mb-3 ${
            currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
          }`}></div>
          <div className="space-y-3">
            {[1, 2].map((i) => (
        ...
        <div>
          <div className={`h-5 w-24 rounded mb-3 ${
            currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
          }`}></div>
          <div className="space-y-3">
            {[1, 2].map((i) => (
...
export function DocumentsCardSkeleton() {
  ...
  return (
    <div className={`border rounded-xl shadow-lg h-full flex flex-col ${
      currentTheme === "dark" 
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 animate-pulse">
        <div className={`w-24 h-24 rounded-xl mb-6 ${
          currentTheme === "dark" ? "bg-gray-700" : "bg-gray-100"
        }`}></div>
        <div className={`h-5 w-64 rounded mb-3 ${
          currentTheme === "dark" ? "bg-gray-700" : "bg-gray-200"
        }`}></div>
...
export function TimelineCardSkeleton() {
  ...
  return (
    <div className={`border rounded-xl shadow-sm animate-pulse h-full flex flex-col ${
      currentTheme === "dark" 
        ? "bg-gray-800 border-gray-700" 
        : "bg-white border-gray-200"
    }`}>
            ...
            <div key={i} className="flex items-start space-x-3">
              <div className="flex flex-col items-center">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  currentTheme === "dark" ? "bg-blue-900/30 border-2 border-blue-500" : "bg-blue-100 border-2 border-blue-400"
                }`}>
              ...
              <div className="flex-1 pb-4">
                ...
                <div className={`h-3 w-full rounded mb-1 ${
                  currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
                }`}></div>
...
export function PipedriveFormCardSkeleton() {
  ...
  return (
    <div className={`border rounded-xl p-6 shadow-sm animate-pulse mb-8 ${
      currentTheme === "dark" 
        ? "bg-gray-800 border-gray-700" 
        : "bg-white border-gray-200"
    }`}>
...
export function DeclinedProcessBannerSkeleton() {
  ...
  return (
    <div className={`border rounded-xl p-5 flex items-start gap-4 mb-8 animate-pulse ${
      currentTheme === "dark" 
        ? "bg-gray-800 border-gray-700" 
      ...
      <div className="flex-1">
        <div className={`h-6 w-40 rounded mb-2 ${
          currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
        }`}></div>
        <div className={`h-4 w-32 rounded mb-1 ${
          currentTheme === "dark" ? "bg-gray-600" : "bg-gray-200"
        }`}></div>
                ...
                <div className="w-16 h-16 relative">
                  <div 
                    className={`absolute inset-0 rounded-full border-4 ${
                      currentTheme === "dark" ? "border-blue-800" : "border-blue-200"
                    }`} 
                    suppressHydrationWarning
                  ></div>

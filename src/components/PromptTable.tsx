    ...
    <>
      <div>
                  ...
                  <TableRow
                    ...
                    className={`border-b transition-all duration-200 cursor-pointer group hover:shadow-sm ${
                      theme === "dark"
                        ...
                        : "hover:bg-secondary/10 border-gray-100"
                    }`}
                  >
                    ...
                    <TableCell
                      className="whitespace-nowrap max-w-[220px] overflow-hidden text-ellipsis py-4 px-6"
                    ...
                    <TableCell className="text-right py-4 px-6">
                      <div className="flex gap-3 justify-end whitespace-nowrap">
                        ...
                        <Button
                          ...
                          className={`rounded-lg px-3 py-1 transition-colors ${
                            theme === "dark"
                              ? "text-destructive-foreground hover:text-destructive hover:bg-destructive/10"
        ...
        {!isLoading && totalPages > 1 && onPageChange && (
          <div
            className={`flex flex-col md:flex-row items-center justify-between mt-8 gap-4 md:gap-0 px-6 py-4 border-t ${
              theme === "dark"
              ...
              <Button
                ...
                className={`rounded-xl transition-colors ${
                  theme === "dark"
                    ...
                    : "border-gray-200 hover:bg-secondary/10 hover:border-gray-200"
                }`}
              >
                Anterior
              </Button>
      ...
      {openContent && (
        <Dialog open={!!openContent} onOpenChange={() => setOpenContent(null)}>
          ...
          >
            ...
            <div
              className={`whitespace-pre-wrap break-words text-sm max-h-[60vh] overflow-auto p-4 rounded-xl border ${
                theme === "dark"

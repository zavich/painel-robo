...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`w-full max-w-6xl grid lg:grid-cols-2 gap-12 relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
      >
        {/* Left Side - Branding */}
        <div
          className={`hidden lg:flex flex-col justify-center items-start space-y-10 p-8 text-white`}
        >
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-white">Juri Capital</h1>
            ...
            <div className="grid grid-cols-1 gap-6 w-full">
              <div className="flex items-center space-x-4 p-6 rounded-2xl border transition-all duration-300 hover:scale-105 bg-gray-800/50 border-gray-700 hover:bg-gray-800/70">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Seus dados protegidos com criptografia avançada e protocolos
              ...
              <div className="flex items-center space-x-4 p-6 rounded-2xl border transition-all duration-300 hover:scale-105 bg-gray-800/50 border-gray-700 hover:bg-gray-800/70">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Monitore seus processos a qualquer momento com notificações
                    em tempo real
                  </p>
                </div>
              </div>
      ...
      {/* Mobile Branding */}
      <div
        className={`lg:hidden absolute top-8 left-1/2 transform -translate-x-1/2 flex items-center space-x-3 text-white transition-all duration-1000 delay-500 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4"}`}
      >
        <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg">
          <Scale className="h-6 w-6 text-white" />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-white">Juri Capital</h1>
          <p className="text-sm text-gray-300">Análises de processos</p>
        </div>
      </div>
    </div>
  );
